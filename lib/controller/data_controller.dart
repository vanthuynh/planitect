...
class DataController extends GetxController{
 ...
 Future<String> uploadThumbnailToFirebase(Uint8List file) async {
   ...
   TaskSnapshot taskSnapshot = await uploadTask.whenComplete(() => null);
   await taskSnapshot.ref.getDownloadURL().then((value) {
     fileUrl = value; // value is download URL
   });
 ...
 // this function create an event into firebase
 Future<bool> createEvent(Map<String,dynamic> eventData)async{
   ...
   .then((value) {
     isCompleted = true;
     Get.snackbar('Event Uploaded', 'Event is uploaded successfully.',colorText: Colors.white,backgroundColor: Colors.blue);
   }).catchError((e){
     isCompleted = false;
   });
