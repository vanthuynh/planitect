...
import 'package:van_main_flutter_app/controller/data_controller.dart';
import 'package:van_main_flutter_app/model/event_media_model.dart';
...
class _CreateEventViewState extends State<CreateEventView> {
  ...
  var selectedFrequency = -2; // -2 means we no frequency has been selected

  // method that reset all values of the controller
                      ...
                      onpress: () async {
                        ...
                        if(media.isNotEmpty){
                          for(int i=0;i<media.length;i++){
                            if(media[i].isVideo!){
                              /// if video then first upload video file
                              /// and then upload thumbnail
                        ...
                        // call createEvent() from data_controller.dart to upload data onto firebase
